...
namespace YZMT {
    ...
    inline vec2 vec2::xAxis() {
        return vec2 { 1.0f, 0.0f };
    }
    
    inline vec2 vec2::yAxis() {
    ...
    inline float vec2::MagnitudeSquared() const {
        return x * x + y * y;
    }
    ...
    inline vec3 vec3::xAxis() {
        return vec3 { 1.0f, 0.0f, 0.0f };
    }
    
    inline vec3 vec3::yAxis() {
        return vec3 { 0.0f, 1.0f, 0.0f };
    }
    
    inline vec3 vec3::zAxis() {
    ...
    inline vec4 vec4::xAxis() {
        return vec4 { 1.0f, 0.0f, 0.0f, 0.0f };
    }
    
    inline vec4 vec4::yAxis() {
        return vec4 { 0.0f, 1.0f, 0.0f, 0.0f };
    }
    
    inline vec4 vec4::zAxis() {
    ...
    inline float vec4::MagnitudeSquared() const {
